 /*
Desc: to test the eligibility for deployment post training. Need to fulfill all the 4 conditions.    Read the score inputs from user at runtime. (Use if     else and switch together).
  i. Test1 Score >= 75%
  ii. Test2 Score >= 75%
  iii. Test3 Score >= 70%
